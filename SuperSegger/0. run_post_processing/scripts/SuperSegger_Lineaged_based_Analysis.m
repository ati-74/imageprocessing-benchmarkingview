function lable = SuperSegger_Lineaged_based_Analysis(dataset,mode)
...
% write to csv
writetable(T2,strcat(write_directory,'SuperSegger_Lineage_based_Analysis.csv'),'Delimiter',',','QuoteStrings',true)
