function [] = SuperSegger_Num_cells(dataset,mode)
...
% write to csv
writetable(T2,strcat(write_directory,'SuperSegger_Num_cells_in_each_timeStep.csv'),'Delimiter',',','QuoteStrings',true)
